 ...
 */
package br.inf.jjd.embeddedkafka.adapter.kafka.event.dto;
...
public class Contact extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -425407804143053558L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Contact\",\"namespace\":\"br.inf.jjd.embeddedkafka.adapter.kafka.event.dto\",\"fields\":[{\"name\":\"name\",\"type\":[\"null\",\"string\"]},{\"name\":\"phoneNumber\",\"type\":[\"null\",\"string\"]}]}");
   ...
   */
  public Contact(java.lang.CharSequence name, java.lang.CharSequence phoneNumber) {
    this.name = name;
   ...
   */
  public static br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder newBuilder() {
    return new br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder();
  }
   ...
   * @return A new Contact RecordBuilder
   */
  public static br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder newBuilder(br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder other) {
    if (other == null) {
      return new br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder();
    } else {
      return new br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder(other);
    }
  }
   ...
   * @return A new Contact RecordBuilder
   */
  public static br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder newBuilder(br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact other) {
    if (other == null) {
      return new br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder();
    } else {
      return new br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Contact>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder setPhoneNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.inf.jjd.embeddedkafka.adapter.kafka.event.dto.Contact.Builder clearPhoneNumber() {
      phoneNumber = null;
